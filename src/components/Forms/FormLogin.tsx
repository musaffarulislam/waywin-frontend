...
const FormLogin = () => {
  ...
  return (
    <form className="rounded flex flex-col justify-center" onSubmit={handleSubmit(onSubmit)}>
        ...
        <button type="submit" className={` ${theme === "dark" ? "bg-blue-800" : "bg-red-600 text-white"} w-5/12 p-3 mt-8 rounded-xl text-2xl flex items-center justify-center` }> {isLoading && <Puff height="25" width="25" className="me-3"/>}Submit</button>
        </div>
