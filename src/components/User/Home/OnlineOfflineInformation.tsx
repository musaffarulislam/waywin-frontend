...
const OnlineOfflineInformation  = () => {
    return (
            <div className="flex flex-col items-start max-w-screen-sm md:flex-row sm:mx-auto">
                ...
                <div>
                    ...
                    <h2 className="mb-4 font-sans text-3xl font-bold tracking-tight sm:text-4xl sm:leading-none">
                        Book Online & Offline Time Slots
                    </h2>
                    <p className="text-base text-gray-900 dark:text-indigo-200 md:text-md">
                    We are excited to introduce our latest feature - Online & Offline Booking! Now, you can book trainers for both online and offline sessions.
                            Trainers can specify their availability for online virtual sessions and offline in-person meetings.
                            Whether you prefer the convenience of online coaching or the personalized experience of face-to-face interactions, our trainers are here to cater to your needs.
                            Reserve your preferred date and time, and choose the mode of interaction that suits you best - online or offline!
                    </p>
...
export default OnlineOfflineInformation ;
