...
export default function Calander({availableDates}: any) {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-2 bg-stone-50">
      ...
      <div className={cn(calendarTouched && "block")}>
        ...
        <AvailableHours onSelectedTime={handlehours} availableDates={availableDates} freeTimes={freeTimes} selectedDay={selectedDay} />
      </div>
    </div>
  )
}
