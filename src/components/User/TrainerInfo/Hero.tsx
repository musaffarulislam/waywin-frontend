  ...
  return (
    <div className='px-6 pt-8 md:pt-16 sm:px-14 md:px-40 m-16 mb-60 mx-auto max-w-screen-xl'>
      ...
      <div className="flex justify-center gap-4">
        <button className="bg-blue-800 text-white dark:bg-red-600  p-3 px-12 mb-8 rounded-xl text-2xl flex items-center justify-center" onClick={handleMessage} >Message</button>
