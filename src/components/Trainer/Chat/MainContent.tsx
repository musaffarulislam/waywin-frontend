...
export const MainContent = () => {
  ...
  const { userId, chatId } = useParams()
    ...
    useEffect(() => {
      ...
      useEffect(() => { 
          ...
          if (selectedChat) { 
            ...
            if (selectedUser) {
              // Store the user information in userInfo
    ...
    return (
      <div className='p-4 sm:ml-96 pt-16 h-screen'>
        <div className="pt-12 h-full">
          <div className="relative h-full overflow-hidden p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 flex flex-col ">
              <div className="text-primary_dark flex justify-between items-center px-10 py-3 bg-slate-50 shadow-2xl rounded-xl cursor-pointer">
                <div className="flex items-center gap-2 text-xl">
                  <div className="inset-0 flex flex-col items-center justify-start w-12 h-12  rounded-2xl ">
                    { userInfo && userInfo?.profileImssage?.url ?
                        <>
