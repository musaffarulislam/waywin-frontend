...
const InputCheckbox = ({ onOptionServices }: optionProps) => {
  ...
  return (
    <div>
      ...
      <div  className="flex justify-center">
        <div className="w-full md:w-10/12 lg:w-8/12 flex  p-4 mb-4  text-blue-800 rounded-lg bg-blue-50 dark:bg-slate-100 dark:text-blue-600" role="alert">
